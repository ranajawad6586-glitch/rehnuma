...
def upgrade() -> None:
    # PostGIS must exist before the geometry column is created.
    ...
    op.create_geospatial_index('idx_plots_geom', 'plots', ['geom'], unique=False, postgresql_using='gist', postgresql_ops={})
...
def downgrade() -> None:
    ...
    op.drop_geospatial_index('idx_plots_geom', table_name='plots', postgresql_using='gist', column_name='geom')
